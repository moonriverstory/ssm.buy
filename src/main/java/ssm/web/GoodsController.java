...
import ssm.dto.BaseResult;
import ssm.entity.Goods;
import ssm.enums.ResultEnum;
import ssm.exception.BizException;
...
public class GoodsController {
    ...
    public String list(Model model, Integer offset, Integer limit, Boolean isRefresh) {
        LOG.info("invoke----------/goods/list");
        offset = offset == null ? 0 : offset;//默认便宜0
        limit = limit == null ? 50 : limit;//默认展示50条
        isRefresh = isRefresh == null ? false : isRefresh; //默认false
        List<Goods> list = goodsService.getGoodsList(offset, limit, isRefresh);
        model.addAttribute("goodslist", list);
        return "goodslist";
    }

//    @RequestMapping(value = "/directlist", method = RequestMethod.GET)
//    public String directlist(Model model, Integer offset, Integer limit) {
//        LOG.info("invoke----------/goods/directlist");
//        offset = offset == null ? 0 : offset;//默认便宜0
//        limit = limit == null ? 50 : limit;//默认展示50条
//        List<Goods> list = goodsService.getGoodsListDirectly(offset, limit);
//        model.addAttribute("goodslist", list);
//        return "goodslist";
//    }
